...
router.post('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), BlogPost_controller_1.BlogPostController.insertIntoDB);
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), BlogPost_controller_1.BlogPostController.getByIdFromDB);
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), BlogPost_controller_1.BlogPostController.updateIntoDB);
