...
router.post('/', (0, validateRequest_1.default)(faq_validation_1.FaqValidation.faqCreateSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), faq_controller_1.FaqController.insertIntoDB);
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), faq_controller_1.FaqController.getByIdFromDB);
router.patch('/:id', (0, validateRequest_1.default)(faq_validation_1.FaqValidation.faqUpdateSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), faq_controller_1.FaqController.updateIntoDB);
