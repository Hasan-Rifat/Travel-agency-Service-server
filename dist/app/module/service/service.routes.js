...
router.post('/', (0, validateRequest_1.default)(service_validation_1.ServiceValidation.serviceCreateSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), service_controller_1.ServiceController.insertIntoDB);
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), service_controller_1.ServiceController.getByIdFromDB);
router.patch('/:id', (0, validateRequest_1.default)(service_validation_1.ServiceValidation.serviceUpdateSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), service_controller_1.ServiceController.updateIntoDB);
